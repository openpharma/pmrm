...
Fit the non-proportional slowing model to a clinical dataset on a
progressive disease.
...
- initial:
  ...
  - `gamma`: a vector with `V` elements, where `V` is the number of
    ...
    `fit <- pmrm_model_slowing_nonproportional(...)`) and then check
  ...
  test model (e.g. `fit <- pmrm_model_slowing_nonproportional(...)`) and
...
``` r
  ...
  str(fit$estimates)
#> List of 9
#>  $ alpha : Named num [1:5] 0.00274 0.80653 0.89579 1.38832 1.65613
#>   ..- attr(*, "names")= chr [1:5] "1" "2" "3" "4" ...
#>  $ theta : num [1:2, 1:4] 0.507 0.578 -0.109 0.168 0.151 ...
#>  $ gamma : num [1:2] 1.01 1.96
#>  $ phi   : num [1:5] 0.00709 -0.0325 0.01658 -0.02733 0.00772
#>  $ rho   : num [1:10] -0.00339 -0.06393 0.02978 -0.10189 -0.07404 ...
#>  $ beta  : num [1:3, 1:5] 0 0 0 0 0.507 ...
#>  $ sigma : num [1:5] 1.007 0.968 1.017 0.973 1.008
#>  $ Lambda: num [1:5, 1:5] 1 -0.00339 -0.06363 0.02964 -0.10012 ...
#>  $ Sigma : num [1:5, 1:5] 1.01429 -0.00331 -0.06515 0.02905 -0.10162 ...
  names(fit)

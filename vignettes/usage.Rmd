...
Just the estimates of actual parameters, omitting functions of other parameters:^[Can be supplied to the `initial` argument of `pmrm_model_decline()`.]
...
The continuous time at each visit is given by the `marginals` argument to `pmrm_model_decline()`.
...
The package supports a `predict()` method for models fit with `pmrm_model_decline()` or `pmrm_model_slowing()`.

...
But to account for intercurrent events such as dropout, we instead assign patient-level marginal likelihoods with missing outcomes integrated out.
...
The proportional slowing modle is the same as the non-proportional variant except the time shifts are now $\beta_1, \ldots, \beta_K$, which no longer depend on the visit.
